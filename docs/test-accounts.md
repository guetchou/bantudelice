# Comptes de test BantuDelice

Environnement : base `bantudelice_repro` (démo pré-lancement)
...
| Email | Mot de passe |
|---|---|
| `admin@bantudelice.cg` | `admin123456` |

Login : `https://bantudelice.cg/login`
...
|---|---|---|
| `client@bantudelice.cg` | `+242 06 500 00 01` | `BantuDelice2026@` |
...
Mot de passe commun : `BantuDelice2026@`
Login : `https://bantudelice.cg/login`
...
Mot de passe commun : `BantuDelice2026@`
Login API : `POST https://bantudelice.cg/api/driver_login` avec champ `phone`
