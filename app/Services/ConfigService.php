...
class ConfigService
{
    ...
    private static function workspaceHomeSeed(string $workspace): array
    {
        return match ($workspace) {
            ...
            'hero_main_image' => self::getConfigValue('home_hero_main_image', 'images/home/food-hero.jpg'),
            ...
            'services_title' => self::getConfigValue('home_services_title', 'Trois services, une seule interface'),
            'services_subtitle' => self::getConfigValue('home_services_subtitle', "BantuDelice rassemble la commande de repas, l'envoi de colis et la réservation de transport avec des parcours distincts et des actions rapides."),
            ...
            'support_description' => self::getConfigValue('home_support_description', "Notre équipe peut vous orienter selon votre besoin: repas, transport ou livraison de colis."),
