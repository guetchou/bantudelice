...
@section('page_title', 'Historique restaurants')
...
<div class="pay-page">
    <div class="pay-card">
        <div class="pay-card__header">
            <h3 class="pay-card__title">Historique transactions restaurants</h3>
        </div>
        <div class="pay-card__body">
            <div class="pay-table-wrap">
                <table class="pay-table" id="dt-rthistory">
                    <thead>
                        <tr>
                            <th>S.No</th>
                            <th>Restaurant</th>
...
<script>
$(function () { $('#dt-rthistory').DataTable({ language: window.bdAdminDataTableLanguage }); });
</script>
@endsection
