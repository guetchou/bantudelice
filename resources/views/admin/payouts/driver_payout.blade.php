...
@section('content')
    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="fas fa-taxi mr-2"></i>Reversements livreurs</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{url('/admin')}}">Accueil</a></li>
                        <li class="breadcrumb-item active">Reversements livreurs</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-start mb-4">
                                <div class="pr-3">
                                    ...
                                    <p class="text-muted mb-2">
                                        Si le <code>transfer</code> temps reel MTN reste bloque, exportez les demandes <code>pending</code> vers le portail bulk payment.
                                    </p>
        ...
        <input type="hidden" name="request_id" value="{{$request->request_id}}">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><i class="fas fa-money-bill-wave mr-2"></i>Reversement livreur</h4>
