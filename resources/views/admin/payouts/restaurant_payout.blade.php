        ...
        <div class="pay-card__body">
            ...
            <div id="pay-panel-requests" class="pay-tab-panel active">
                ...
                <div class="pay-table-wrap">
                    <table class="pay-table" id="dt-rst-requests">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>Lic#</th>
                        ...
                        @forelse($requests as $index => $request)
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="pay-btn-launch"
                                            onclick="document.getElementById('dlg-rst-req-{{ $request->request_id }}').showModal()">
                            ...
                            <dialog class="pay-dialog" id="dlg-rst-req-{{ $request->request_id }}">
                                <div class="pay-dialog__header">
                                    <h4 class="pay-dialog__title"><i class="fas fa-money-bill-wave" style="margin-right:6px;"></i>Reversement restaurant</h4>
            ...
            <div id="pay-panel-history" class="pay-tab-panel">
                <div class="pay-table-wrap">
                    <table class="pay-table" id="dt-rst-history">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>N°</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="pay-btn-detail"
                                            onclick="document.getElementById('dlg-rst-hist-{{ $request->request_id }}').showModal()">
                                        <i class="fas fa-eye"></i>Détails
                                    </button>
                                </td>
                            </tr>

                            <dialog class="pay-dialog pay-dialog--lg" id="dlg-rst-hist-{{ $request->request_id }}">
                                <div class="pay-dialog__header">
...
$(function () {
    $('#dt-rst-requests').DataTable({ language: window.bdAdminDataTableLanguage });
    $('#dt-rst-history').DataTable({ language: window.bdAdminDataTableLanguage });
});
</script>
@endsection
