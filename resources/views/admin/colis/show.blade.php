                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Paiement</b>
                                <a class="float-right badge {{ $paymentBadgeClass }}">
                        ...
                        @if($paymentExperience)
                            <div class="mt-3 p-3 rounded border bg-light">
                                <strong class="d-block text-dark">{{ $paymentExperience['customer_message'] }}</strong>
                                @if(!empty($paymentExperience['failure_reason']))
                                    <small class="d-block text-danger mt-2">Code provider: {{ $paymentExperience['failure_reason'] }}</small>
                                @endif
                                @if(!empty($paymentExperience['support_action']))
                                    <small class="d-block text-muted mt-2">Action back-office: {{ $paymentExperience['support_action'] }}</small>
                                @endif
                            </div>
                        @endif
                    </div>
