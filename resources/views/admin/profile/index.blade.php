        ...
        <div class="row pt-4">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                ...
                <a href="{{ route('admin.pending_orders') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                ...
                <a href="{{ route('admin.metrics') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card p-2">
                    ...
                    <p class="m-0">This is the description or about info of the restaurant. This is the description or about info of the restaurant.</p>
                    <hr class="m-0">
