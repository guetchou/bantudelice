...
@section('page_title', 'Commandes en attente')
...
<div class="ord-wrap" style="padding:20px;">
    ...
    <div class="ord-filter">
        ...
        <form action="{{ route('admin.pending_orders') }}" method="get">
    ...
    <div class="ord-card">
        <div class="ord-card__head">
            <div>
                <p class="ord-card__title">Nouvelles commandes</p>
                <p class="ord-card__count">{{ $orders->count() }} commande(s)</p>
            </div>
        </div>
        <div class="ord-table-wrap">
            <table class="ord-table" id="ord-table-pending">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>N° commande</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="ord-pill ord-pill--warn">{{ $order->status }}</span></td>
                        <td>
