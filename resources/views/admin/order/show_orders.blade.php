...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Details de la commande</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Accueil</a></li>
                        <li class="breadcrumb-item "><a href="{{ route('admin.all_orders') }}">Commandes</a></li>
        ...
        <div class="container-fluid">
                            ...
                            <div class="card card-primary card-outline">
                              <div class="card-body box-profile">
                                <div class="text-center">
                                  <img class="rounded-circle" style="border: 2px solid #007bff;" width="75" height="75" src="{{asset('images/restaurant_images/'.$order->restaurant->logo)}}" alt="Photo de profil utilisateur">
                                </div>
                                ...
                                <a href="{{ route('restaurant.show', $order->restaurant->id) }}" class="btn bg-gradient-primary btn-block"><b>Restaurant</b></a>
                              </div>
                              <!-- /.card-body -->
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="card card-warning card-outline">
                              <div class="card-body box-profile">
                                ...
                                <a href="{{ route('driver.show', $order->driver->id) }}" class="btn bg-gradient-warning btn-block"><b>Livreur</b></a>
                              </div>
                              <!-- /.card-body -->
                            </div>
                            @else
                            <div class="card card-warning card-outline">
                              <div class="card-body box-profile">
                                ...
                                <h3 class="profile-username text-center">Livreur non assigne</h3>
                                ...
                                <button type="button" class="btn bg-gradient-warning btn-block" disabled><b>Livreur non assigne</b></button>
                              </div>
                              <!-- /.card-body -->
                            </div>
                            @endif
                        ...
                        <div class="col-md-4">
                            <div class="card card-success card-outline">
                              <div class="card-body box-profile">
                                ...
                                @php
                                    $customerPhoneLink = preg_replace('/[^0-9+]/', '', (string) ($order->user->phone ?? ''));
                                @endphp
                                @if($customerPhoneLink)
                                    <a href="tel:{{ $customerPhoneLink }}" class="btn bg-gradient-success btn-block"><b>Appeler le client</b></a>
                                @else
                                    <button type="button" class="btn bg-gradient-success btn-block" disabled><b>Client</b></button>
                                @endif
                              </div>
                              <!-- /.card-body -->
                            </div>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Numero de commande</span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Taxe</span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Frais de livraison</span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Pourboire</span>
                            ...
                            <div class="col-md-12">
                                <div class="card card-outline card-warning">
                                    <div class="card-header">
                                        <h3 class="card-title">Incident et support livraison</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3"><strong>Statut livraison:</strong> {{ $order->delivery->status }}</div>
                                            <div class="col-md-3"><strong>Incident:</strong> {{ $order->delivery->incident_status ?? 'aucun' }}</div>
                                            <div class="col-md-3"><strong>Motif:</strong> {{ $order->delivery->incident_reason ?? 'n/a' }}</div>
                                            <div class="col-md-3"><strong>Support:</strong> {{ $order->delivery->support_status ?? 'n/a' }}</div>
                                        </div>
                                        @if($order->delivery->incident_notes || $order->delivery->support_notes)
                                            <div class="mt-3">
                                                <strong>Détails:</strong>
                                                <div class="text-muted mt-1">{{ $order->delivery->incident_notes ?? $order->delivery->support_notes }}</div>
                                            </div>
                                        @endif
                                        @if(($order->delivery->incident_status ?? null) === 'open')
                                            <form method="POST" action="{{ route('admin.resolve_incident', ['order' => $order->order_no]) }}" class="mt-4">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="form-group col-md-3">
                                                        <label>Décision support</label>
                                                    ...
                                                    <div class="form-group col-md-7">
                                                        ...
                                                        <textarea name="support_notes" rows="2" class="form-control" placeholder="Décision, contexte, action prise."></textarea>
                                                    </div>
                                                    <div class="form-group col-md-2 d-flex align-items-end">
                                                        <button type="submit" class="btn btn-warning btn-block">Appliquer</button>
                                                    </div>
                                                </div>
                                            </form>
                                        @endif
