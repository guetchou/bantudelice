...
@section('title','Commandes en préparation')
...
<div class="ord-wrap" style="padding:20px;">
    ...
    <div class="ord-card">
        <div class="ord-card__head">
            <div>
                <p class="ord-card__title">Commandes en préparation</p>
                <p class="ord-card__count">{{ $orders->count() }} commande(s)</p>
            </div>
        </div>
        <div class="ord-table-wrap">
            <table class="ord-table" id="ord-table-prepare">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Client</th>
