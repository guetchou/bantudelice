...
.ord-card__total { font-size:13px; font-weight:700; color:#166534; }
...
<div class="ord-wrap" style="padding:20px;">
    ...
    <div class="ord-card">
        <div class="ord-card__head">
            <div>
                <p class="ord-card__title">Commandes complétées</p>
                <p class="ord-card__count">{{ $orders->count() }} commande(s)</p>
            </div>
            <span class="ord-card__total">
                Total : {{ number_format($orders->sum('total'), 0, ',', ' ') }} FCFA
            </span>
        </div>
        <div class="ord-table-wrap">
            <table class="ord-table" id="ord-table-complete">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>N° commande</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="ord-pill ord-pill--ok">{{ $order->status }}</span></td>
                        <td>
                            <a href="{{ route('admin.show_completed_order', $order->order_no) }}" class="ord-btn-see" title="Voir">
