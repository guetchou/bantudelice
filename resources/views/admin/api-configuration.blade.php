                                    ...
                                    <form id="api-keys-form">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header" data-toggle="collapse" data-target="#mtn-config" style="cursor: pointer;">
                                                <h6 class="mb-0"><i class="fas fa-mobile-alt"></i> Mobile Money - MoMo</h6>
                                            </div>
                                            <div id="mtn-config" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_COLLECTIONS_PRIMARY_KEY</label>
                                                                ...
                                                                <small class="form-text text-muted">Subscription key primaire pour les encaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_COLLECTIONS_SECONDARY_KEY</label>
                                                                ...
                                                                <small class="form-text text-muted">Subscription key secondaire pour les encaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_COLLECTIONS_SUBSCRIPTION_KEY</label>
                                                                ...
                                                                <small class="form-text text-muted">Override explicite de la subscription key utilisee a la place de primary/secondary</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_COLLECTIONS_API_USER</label>
                                                                <input type="text" name="keys[MOMO_COLLECTIONS_API_USER]" 
                                                                       class="form-control api-key-input" 
                                                                       placeholder="API User Collections"
                                                                       id="key-MOMO_COLLECTIONS_API_USER">
                                                                <small class="form-text text-muted">API user pour les encaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_COLLECTIONS_API_KEY</label>
                                                                <input type="password" name="keys[MOMO_COLLECTIONS_API_KEY]" 
                                                                       class="form-control api-key-input" 
                                                                       placeholder="API Key Collections"
                                                                       id="key-MOMO_COLLECTIONS_API_KEY">
                                                                <small class="form-text text-muted">API key pour les encaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_CALLBACK_URL</label>
                                                                ...
                                                                <small class="form-text text-muted">URL de callback utilisée pour les notifications MTN</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_DISBURSEMENTS_PRIMARY_KEY</label>
                                                                ...
                                                                <small class="form-text text-muted">Subscription key primaire pour les decaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_DISBURSEMENTS_SECONDARY_KEY</label>
                                                                ...
                                                                <small class="form-text text-muted">Subscription key secondaire pour les decaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_DISBURSEMENTS_SUBSCRIPTION_KEY</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_DISBURSEMENTS_API_USER</label>
                                                                ...
                                                                <small class="form-text text-muted">API user pour les décaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_DISBURSEMENTS_API_KEY</label>
                                                                ...
                                                                <small class="form-text text-muted">API key pour les décaissements MoMo</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>MOMO_ENVIRONMENT</label>
                                                                <input type="text" name="keys[MOMO_ENVIRONMENT]" 
                                                                       class="form-control api-key-input" 
                                                                       placeholder="sandbox"
                                                                       id="key-MOMO_ENVIRONMENT">
                                                                <small class="form-text text-muted">Valeurs attendues: sandbox ou production</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>MOMO_TARGET_ENVIRONMENT</label>
                                                                <input type="text" name="keys[MOMO_TARGET_ENVIRONMENT]" 
                                                                       class="form-control api-key-input" 
                                                                       placeholder="sandbox"
                                                                       id="key-MOMO_TARGET_ENVIRONMENT">
                                                                <small class="form-text text-muted">Sandbox pour les tests, ou la valeur cible fournie par MTN en production</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="google-auth-config" class="collapse">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>GOOGLE_AUTH_ENABLED</label>
                                                                <input type="text" name="keys[GOOGLE_AUTH_ENABLED]"
                                                                       class="form-control api-key-input"
                                                                       placeholder="true"
                                                                       id="key-GOOGLE_AUTH_ENABLED">
                                                                <small class="form-text text-muted">Mettre <code>true</code> pour activer Google Sign-In.</small>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <small class="form-text text-muted">URI de callback exacte à déclarer dans Google Cloud.</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="alert alert-light border">
                                                                ...
                                                                @endforeach
                                                                <div class="mt-2"><strong>Redirect URI autorisée</strong></div>
                                            ...
                                            <div id="facebook-config" class="collapse">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>FACEBOOK_AUTH_ENABLED</label>
                                                                <input type="text" name="keys[FACEBOOK_AUTH_ENABLED]"
                                                                       class="form-control api-key-input"
                                                                       placeholder="true"
                                                                       id="key-FACEBOOK_AUTH_ENABLED">
                                                                <small class="form-text text-muted">Mettre <code>true</code> pour activer Facebook Login.</small>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label>FACEBOOK_REDIRECT_URI</label>
                                                                ...
                                                                <small class="form-text text-muted">URI de callback exacte à déclarer dans Meta Developers.</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
