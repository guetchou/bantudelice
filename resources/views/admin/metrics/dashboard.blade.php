...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h3 mb-0">Metriques et observabilite</h1>
            <p class="text-muted">Indicateurs temps reel et historique.</p>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p><code>GET {{ route('admin.metrics.realtime') }}</code> - Métriques temps réel (JSON, session admin)</p>
                    <p><code>GET {{ route('admin.metrics.historical', ['days' => 30]) }}</code> - Métriques historiques (JSON, session admin)</p>
                </div>
            </div>
        </div>
    </div>
