                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="qr-el qr-el-3"
                                            ...
                                            <label for="file-input" class="hoviringdell uploadBox" id="uploadTrigger"
                                                ...
                                                <img src="{{ asset('images/home/service-restaurant.jpg') }}" style="width: 90px;" id="logo" alt="logo">
                                                <div class="uploadText" style="font-size: 12px;">
                                                    <span style="color:#ff5a1f;"><i class="fas fa-upload mr-1"></i>Télécharger le logo</span><br>
                                                    Taille 90x90
                                                </div>
                                            </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="qr-el qr-el-3"
                                            ...
                                            <label for="upload_file" class="hoviringdell uploadBox"
                                                   id="uploadTrigger"
                                                   style="height: 110px; text-align:center; width:100%; border:dotted 2px #cccccc;">
                                                <img src="{{ asset('images/home/service-restaurant.jpg') }}" style="width: 90px;" id="cover" alt="cover">
                                                <div class="uploadText" style="font-size: 12px;">
                                                    <span style="color:#ff5a1f;"><i class="fas fa-upload mr-1"></i>Télécharger la bannière</span><br>
                                                    Taille 320x220
                                                </div>
                                            </label>
