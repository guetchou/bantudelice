...
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Preparing orders</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                       ...
                       <div class="card-header">
                           ...
                           <div class="col-sm-6"><button type="submit" class="btn btn-outline-success btn-sm float-right">Assigner les commandes</button></div>
                        </div>
                        ...
                        <div class="card-body table-responsive p-2">
                            <table class="table table-head-fixed text-nowrap" id="example1">
                                ...
                                @foreach($orders as $index => $order)
                                    <tr>
     <td><input type="checkbox" name="id[]" value="{{$order->order_no}}"></td>
