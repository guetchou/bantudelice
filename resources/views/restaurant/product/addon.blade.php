...
@section('title','Suppléments optionnels et obligatoires')
                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                              <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-three-optional-tab" data-toggle="pill" href="#custom-tabs-three-optional" role="tab" aria-controls="custom-tabs-three-optional" aria-selected="true">Optionnels</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-three-required-tab" data-toggle="pill" href="#custom-tabs-three-required" role="tab" aria-controls="custom-tabs-three-required" aria-selected="false">Obligatoires</a>
                              </li>
                            </ul>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card shadow">
                                                <div class="card-header">
                                                    <h3>Suppléments optionnels</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="">
                                                        <img class="d-inline rounded" width="50" src="../../images/product_images/{{$prod->image}}">
                                                        <p class="d-inline"><span><b>Nom :</b></span>{{$prod->name}}</p>
                                                    </div>
                                                    <br>
                                                    <form method="post" role="form" action="{{ route('optional.store') }}" >
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-sm-12 col-xs-12">
                                                                <select required class="form-control" name="add_on_title_id">
                                                                    <option selected value="">Sélectionner une famille de suppléments</option>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-sm-6 col-xs-12">
                                                                <input required class="form-control" type="text" name="title" placeholder="Saisir le nom du supplément optionnel" value=""/>
                                                            </div>
                                                            <div class="form-group col-sm-6 col-xs-12">
                                                                <input required class="form-control" type="text" name="price" placeholder="Saisir le prix" value=""/>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="form-group">
                                                                <button type="submit" class="btn bg-gradient-info">Ajouter</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-three-required" role="tabpanel" aria-labelledby="custom-tabs-three-required-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card shadow">
                                                <div class="card-header">
                                                    <h3>Suppléments obligatoires</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="">
                                                        <img class="d-inline rounded" width="50" src="../../images/product_images/{{$prod->image}}">
                                                    ...
                                                    <form method="post" role="form" action="{{ route('required.store') }}"enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-sm-6 col-xs-12">
                                                                <input required class="form-control" type="text" name="title" placeholder="Saisir le nom du supplément obligatoire" value=""/>
                                                            </div>
                                                            <div class="form-group col-sm-6 col-xs-12">
                                                                <input required class="form-control" type="text" name="price" placeholder="Saisir le prix" value=""/>
                                                            </div>
