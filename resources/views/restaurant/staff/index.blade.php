                ...
                <table class="staff-table">
                    ...
                    @foreach($members as $member)
                        <tr>
                            ...
                            <td>
                                @if($currentRole === 'manager' && $member->role === 'manager')
                                    <span class="staff-locked"><i class="fas fa-lock"></i> Réservé au propriétaire</span>
                                @else
